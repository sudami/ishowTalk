...
public class MaterialProgressBar extends View {
   ...
   // Color.parseColor("#039BE5");
    ...
    public MaterialProgressBar(Context context, AttributeSet attrs) {
        ...
        barColor = a.getColor(R.styleable.materialprogressbar_barcolor, getResources().getColor(R.color.colorPrimary));
        linearProgress = a.getBoolean(R.styleable.materialprogressbar_barcolor, false);
        a.recycle();
